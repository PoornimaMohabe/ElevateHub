      ...
      <section className="bg-[#F1F7FF] py-24 px-6 md:px-20 flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1">
          ...
          <p className="text-lg text-gray-700 mb-8 max-w-xl">
            ...
            experience. Help others grow, build meaningful connections, and make
            a lasting impact on future professionals.
          </p>
          <button
            onClick={() => setIsMentorModalOpen(true)}
            className="bg-[#F7903D] hover:bg-[#e3792b] text-white font-semibold px-8 py-3 rounded-full text-lg shadow-lg transition-all duration-300"
          >
            Become a Mentor
          </button>
        </div>
