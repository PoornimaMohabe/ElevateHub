    ...
    <div className="w-full min-h-screen  bg-gray-50">
      ...
      <div className="relative w-full h-[600px]">
        <div className="absolute inset-0 bg-slate-800 bg-opacity-80 flex flex-col justify-center items-center text-white p-4 z-10">
          <h4 className="text-3xl font-bold mb-4 text-center">
            You are the true pillars of ElevateHub
          </h4>
          <p className="text-lg text-center max-w-2xl">
            Welcome to your mentor dashboard! Here you can guide, inspire, and
            empower the future. Fill the gap with your knowledge and experience.
          </p>
        </div>
        <img
          src={mentorhome}
      ...
      <div className="text-center mt-20">
        ...
        <p className="text-lg text-gray-600">
          Manage mentorship requests, post opportunities, and make a lasting
          impact.
        </p>
      </div>
        ...
        <div className="col-span-2 flex flex-col justify-center items-start space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-gray-600">
              Review and connect with students seeking your guidance.
            </p>
            <Link to="/mentorship-request">
              <button className="mt-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-md font-semibold transition">
                Get Started
              </button>
            </Link>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600">
              Help students find opportunities by posting jobs and internships.
            </p>
            <Link to="/postJob">
              <button className="mt-2 bg-purple-600 hover:bg-purple-700 text-white px-5 py-2 rounded-md font-semibold transition">
                Post Now
              </button>
            </Link>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600">
              Build your personal brand while making a difference in someone’s
              journey.
            </p>
          </div>
        </div>
