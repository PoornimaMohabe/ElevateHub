        ...
        <div className="bg-gray-100 min-h-screen p-6">
            <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row gap-6 p-8">
                    <img
                        src="https://southfloridaclassicalreview.com/wp-content/uploads/2015/02/Discography-Pic-Matt-Dineweb1.jpg"
                        alt="Nguyen Shane"
                    ...
                    <div className="flex-1 sm:mt-[auto]">
                        <div className="flex justify-between items-center gap-2 ">
                            <h2 className="text-xl font-bold">#2 Nguyen Shane</h2>
                            <button className="bg-lime-800 text-white px-4 py-2 text-sm md:p-4 md:text-base rounded-md">
                                Book Mentor
                            </button>
                        </div>
                ...
                <div className="md:flex gap-10 p-8 pt-4">
                    ...
                    <div className="md:w-2/3">
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed">
                            ...
                            With this qualification, I’m equipped to dive deep into the world of coding and development, ready to tackle exciting
                            projects and contribute to cutting-edge technological advancements…
                        </p>
                        <span className="text-blue-500 text-sm cursor-pointer mt-1 inline-block">See more</span>
                    </div>

                    {/* Contact Details */}
                    <div className="md:w-1/3">
                        <h3 className="text-sm font-semibold mb-2 sm:mt-3">Contact Details</h3>
                        <p className="text-xs text-gray-500">EMAIL ADDRESS</p>
                        <p className="text-sm text-blue-500 mb-4">hello@nguyen.shane.com</p>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {['User Interface', 'User Experience', 'Interaction Design', '3D Design', 'Information Architecture', 'User Research', 'Wireframing'].map(skill => (
                                <span
                                    key={skill}
